...
module.exports = {
    ...
    execute(client, message, args) {        
        ...
        var randomMsg = ['đứng đứng đường nhận', 'vừa được lì xì', 'vừa nhặt được', 'đã làm việc chăm chỉ và nhận được', 'bạn đã cướp ngân hàng được'];
        ...
        message.reply({embeds: [{
            description: "Bạn " + content + " " + sodep(got) + " " + client.emoji.dongxu,
            color: "0FF1CE",
